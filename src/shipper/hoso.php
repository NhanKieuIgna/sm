...
// --- CHỈNH SỬA Ở ĐÂY: Tính SUM(TongGiaTriDonHang * 0.05) thay vì SUM(PhiGiaoHang) ---
$sql_stats = "SELECT 
...
// Format revenue: total_delivery_fee is the column from the database, now calculated as 5% of TongGiaTriDonHang
...
<div class="profile-page">
	...
	<main class="main">
		<div class="profile-header">
			<div class="avatar">
				<img src="../uploads/shipper_documents/<?php echo $user['AnhDaiDien']; ?>" alt="<?php echo $user['name']; ?>">
			</div>
			<div class="user-info">
