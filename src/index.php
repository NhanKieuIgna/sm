            ...
            <div class="products-grid">
                <?php if (!empty($featured_products)): ?>
                    <?php foreach ($featured_products as $product): ?>
                        <a href="product-detail.php?id=<?php echo $product['ID_SanPham']; ?>" style="text-decoration: none; color: inherit; display: block;">
                            <div class="product-card" style="cursor: pointer;">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-actions">
                                        <button class="btn-add-cart" onclick="event.preventDefault(); event.stopPropagation(); addToCart(<?php echo $product['ID_SanPham']; ?>);">thêm vào</button>
                                        <button class="btn-buy-now" onclick="event.preventDefault(); event.stopPropagation(); window.location.href='product-detail.php?id=<?php echo $product['ID_SanPham']; ?>';">mua ngay</button>
                                    </div>
                                </div>
                            </div>
                        </a>
