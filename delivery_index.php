...
// Lấy thông tin tài xế (tên + avatar)
$sql_profile = "SELECT HoTen, AnhDaiDien FROM nguoidung WHERE ID_NguoiDung = $driver_id";
...
// Thống kê đơn hàng và COD cần thu
$sql_stats = "SELECT 
...
/* Profile */
.profile { display: flex; gap: 15px; margin: 20px 0; flex-direction: column; }
        ...
        <div class="profile">
            <div class="avatar">
                <a href="hoso.php" style="color: inherit; text-decoration: none;">
                    <?php 
                    if (!empty($driver_avatar)): ?>
                        <img src="sm/uploads/<?php echo $driver_avatar; ?>" alt="Avatar">
                    <?php else: ?>
